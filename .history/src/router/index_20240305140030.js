...
const businessKanban = "@/pages/transactionDeclaration/transactionExecution";
        ...
        routes: [
            {
                ...
                routes: [
                    ...
                    {
                        path: "/vpp/transaction-declaration/trading-dashboard",
                        component: transactionDeclaration,
                    },
                    {
                        path: "/vpp/transaction-declaration/do-declaration",
                        component: doDeclaration,
                    },
                    {
                        path: "/vpp/transaction-declaration/application-list",
                        component: applicationList,
                    },
                    {
                        path: "/vpp/transaction-declaration/transaction-execution",
                        component: transactionExecution,
                    },
                    {
                        path: "/vpp/transaction-declaration/business-kanban",
                        component: transactionExecution,
                    },
                ],
            },
