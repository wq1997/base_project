                    ...
                    content={
                        ...
                        <div className={styles.contentChart}>
                            <Charts3D
                                ...
                                data={Object.keys(
                                    initData?.plantSummery?.province2PlantCount || {}
                                )?.map(city => {
                                    return {
                                        name: city,
                                        value: initData?.plantSummery?.province2PlantCount?.[
                                            city
                                        ],
                                    };
                                })}
                            ...
                            <div className={styles.areaContentDataItem}>
                                ...
                                <div className={styles.areaContentDataItemData}>
                                    <span className={styles.areaContentDataItemData1}>
                                        {dataSource?.plantSummery?.totalCapacity}
                                    </span>
