...
const Index = ({ plants, activePlant, setActivePlant }) => {
    ...
    const addMarkers = (map, plants) => {
        plants.forEach((item, index) => {
            const marker = new AMap.Marker({
                ...
                label: {
                    ...
                    <div class=${styles.plantInfo} >
                        <div class=${styles.plantName} title=${item.plantName}>
                           <div class=${styles.arrow}></div>
                           <span class=${styles.name}>${item.plantName}</span>
                        </div>
                        <div class=${styles.status}>
                           <div class=${styles.status}>
                                <div class=${styles.arrow}>通讯状态：</div>
                                <div class=${styles.arrow}>全部设备离线</div>
                           </div>
                           <div class=${styles.status}>
                                <div class=${styles.arrow}>报警状态：</div>
                                <div class=${styles.arrow}>无报警</div>
                           </div>
                        </div>
                    </div>
                    `,
            ...
            //<img class=${styles.online} src=${online}></img>
            marker.on("click", e => {
