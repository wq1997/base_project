    ...
    const addMarkers = (map, infoWindow, plants) => {
        plants.forEach((item, index) => {
            const marker = new AMap.Marker({
                ...
                content: ` <div class=${styles.infoWindow}><div class=${styles.header}><div class=${styles.row}></div><span class=${styles.plantName}>${item.plantName}</span></div><img src=${mapPoint} /></div>`,
            });
