        ...
        options1 = {
            ...
            xAxis: {
                ...
                data: [
                    ...
                    2.16, 2.17, 2.18, 2.19, 2.2, 2.21, 2.22, 2.23, 2.24, 2.25, 2.26, 2.27, 2.28,
                    2.29,
                ],
            },
            yAxis: {
            ...
            series: [
                {
                    ...
                    stack: "one",
                    data: [
                        300, 288, 290, 300, 287, 298, 280, 300, 289, 299, 288, 300, 295, 300, 299,
                        300, 300, 300, 281, 300, 298, 296, 300, 300, 298, 287, 300, 290, 290,
                    ],
                },
                {
                    name: "日放电",
                    ...
                    stack: "one",
                    data: [
                        -300, -288, -290, -300, -287, -298, -280, -300, -289, -299, -288, -300,
                        -295, -300, -299, -300, -300, -300, -281, -300, -298, -296, -300, -300,
                        -298, -287, -300, -290, -290,
                    ],
                },
            ],
    ...
    return (
        <div style={{ marginTop: "10px", height: "100%" }}>
            ...
            <div
                ...
                style={{ paddingTop: "30px", minHeight: "300px", height: "calc(100% - 500px)" }}
            >
                <ReactECharts showLoading={loading} option={options3} style={{ width: "100%", height: "100%" }} />
            </div>
        </div>
    );
};
