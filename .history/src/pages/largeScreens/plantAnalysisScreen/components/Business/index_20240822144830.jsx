...
const Business = ({}) => {
    ...
    const handleSearch = (value, e, source) => {
        ...
        const searchParams = { haiWai: isOverseasRef.current, name: plantNameRef.current };
        const filterPlants = dataSource?.plants?.filter(plant => {
            for (let [key, value] of Object.entries(searchParams)) {
                ...
                if (value != undefined) {            
                    // if (key == "haiWai") {
                    //     return value == plantValue;
                    // }
                    if (!plantValue || !plantValue?.includes(value)) {
                        return false;
                    }
                }
            }
        ...
        //             if (key == "haiWai") {
        //                 return searchValue == plantValue;
        //             }
        //             if (key == "name") {
        //                 return plantValue?.includes(searchValue);
        //             }
        //         }
        //     }
        //     return false;
    ...
    useEffect(() => {
        // if (isOverseas == undefined) return setMapPlants(dataSource?.plants);
        // const filterPlants = dataSource?.plants?.filter(plant => {
        //     return plant?.haiWai == isOverseas;
        // });
        // setMapPlants(filterPlants);
        handleSearch();
    }, [isOverseas]);
