...
const Index = ({ deviceInfo }) => {
    ...
    useEffect(() => {
        ...
        const _dataSource = [['组串'], ['输入电压(V)'], ['输入电压(V)']];
                    ...
                    <div className="table">
                        {dataSource?.map((item, index) => (
                            <div className="item">
                                {item?.map(value => (
                                    <>
                                        {/* {index == 0 && <div className="name">组串</div>}
                                        {index == 1 && <div className="name">输入电压(V)</div>}
                                        {index == 2 && <div className="name">输入电流(A)</div>} */}
                                        <div className={[0,1,2].includes(index) ?'name':"cell"}>{value}</div>
                                    </>
                                ))}
                            </div>
                        ))}
