...
const Index = ({ deviceInfo }) => {
    ...
    const [realData, setRealData] = useState([
        ...
        { label: "当日发电量", key: "dailyGeneration", value: "",unit:'' },
        { label: "累计发电量", key: "totalGeneration", value: "" ,unit:''},
        { label: "功率因数", key: "powerFactor", value: "" },
        { label: "有功功率", key: "activePower", value: "",unit:'' },
        { label: "无功功率", key: "reactivePower", value: "" ,unit:''},
        { label: "逆变器额定功率", key: "ratedPower", value: "" ,unit:''},
        { label: "电网频率", key: "gridFrequency", value: "" ,unit:''},
        { label: "输出方式", key: "outputMode", value: "" },
        { label: "电网A相电流", key: "gridCurrentA", value: "" ,unit:''},
        { label: "电网B相电流", key: "gridCurrentB", value: "" ,unit:''},
        { label: "电网C相电流", key: "gridCurrentC", value: "",unit:'' },
        { label: "电网A相电压", key: "gridVoltageA", value: "" ,unit:''},
        { label: "电网B相电压", key: "gridVoltageB	", value: "",unit:'' },
        { label: "电网C相电压", key: "gridVoltageC", value: "",unit:'' },
        ...
        { label: "内部温度", key: "internalTemperature", value: "" ,unit:''},
    ]);
