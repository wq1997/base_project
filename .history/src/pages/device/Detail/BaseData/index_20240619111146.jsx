...
const Index = ({ deviceInfo }) => {
    ...
    const [realData, setRealData] = useState([
        ...
        { label: "当日发电量(kWh)", key: "dailyGeneration", value: "", unit: "" },
        { label: "累计发电量(kWh)", key: "totalGeneration", value: "", unit: "kWh" },
        { label: "功率因数", key: "powerFactor" },
        { label: "有功功率(kW)", key: "activePower", value: "", unit: "" },
        { label: "无功功率(kVar)", key: "reactivePower", value: "", unit: "" },
        { label: "逆变器额定功率(kW)", key: "ratedPower", value: "", unit: "" },
        { label: "电网频率", key: "gridFrequency", value: "", unit: "" },
        { label: "输出方式", key: "outputMode", value: "" },
        { label: "电网A相电流(A)", key: "gridCurrentA", value: "", unit: "A" },
        { label: "电网B相电流(A)", key: "gridCurrentB", value: "", unit: "A" },
        { label: "电网C相电流(A)", key: "gridCurrentC", value: "", unit: "A" },
        { label: "电网A相电压(V)", key: "gridVoltageA", value: "", unit: "V" },
        { label: "电网B相电压(V)", key: "gridVoltageB	", value: "", unit: "V" },
        { label: "电网C相电压(V)", key: "gridVoltageC", value: "", unit: "V" },
        ...
        { label: "内部温度(°C)", key: "internalTemperature", value: "", unit: "°C" },
    ]);
