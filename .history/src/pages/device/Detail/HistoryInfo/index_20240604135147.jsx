...
const Index = ({}) => {
    ...
    const getOptions = data => {
        ...
        const xAxisData = Object.keys(data?.find(item => item?.value)?.value || {});
        const units = [...new Set(data?.map(item => item.rate))]?.map(item => ({
            type: "value",
            name: item,
            axisLabel: {
        ...
        setOptions({
            ...
            yAxis: [
                ...[...new Set(data?.map(item => item.rate))]?.map(item => ({
                    type: "value",
                    name: item,
                    axisLabel: {
                        formatter: `{value} ${item}}`,
