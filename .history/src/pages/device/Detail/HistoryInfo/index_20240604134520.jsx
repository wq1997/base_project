...
const Index = ({}) => {
    ...
    const getOptions = data => {
        ...
        console.log(Object.keys(data?.find(item => item.value)?.value || {}));
        console.log([...new Set(data?.map(item => item.rate))]?.map(item => ({
            type: "value",
            name: item,
            axisLabel: {
        ...
        setOptions({
            ...
            xAxis: [
                {
                    type: "category",
                    data: Object.keys(data?.find(item => item.value)?.value || {}),
                    axisPointer: {
                        type: "shadow",
                    },
                },
            ],
            yAxis: [...new Set(data?.map(item => item.rate))]?.map(item => ({
                type: "value",
                name: item,
                axisLabel: {
                    formatter: `{value} ${item}}`,
