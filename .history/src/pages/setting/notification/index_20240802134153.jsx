                        ...
                        <Button
                            ...
                            onClick={async () => {
                                ...
                                if (type === "INVITE_SPLIT") {
                                    history.push(
                                        `/vpp/demandResponse/invitation/invitationList?type=${type}`
                                    );
                                }
                                if (type === "RESOURCE_PLAN_CONFIG") {
                                    history.push(
                                        `/vpp/demandResponse/task/confirm?businessKey=${type}`
                                    );
                                }
                                if (type === "PLAN_EXECUTED") {
                                    history.push(
                                        `/vpp/demandResponse/task/detail?businessKey=${type}`
                                    );
                                }
                            }}
                        >
