...
const Index = ({ data }) => {
    const [list, setList] = useState([
        { name: "当日发电量", pic: dayGeneration, key: "dailyGeneration", value: "1123122312", unit: "度" },
        { name: "当月发电量", pic: dayGeneration, key: "monthGeneration", value: "1123122312", unit: "度" },
        { name: "当年发电量", pic: dayGeneration, key: "yearGeneration", value: "1123122312", unit: "度" },
        {
            name: "累计发电量",
