...
const Index = ({ data }) => {
    const [datas, setDatas] = useState([
        { name: "当日发电量", pic: dayGeneration, key: "", data: "", unit: "度" },
        { name: "当月发电量", pic: dayGeneration, key: "", data: "", unit: "度" },
        { name: "当年发电量", pic: dayGeneration, key: "", data: "", unit: "度" },
        { name: "累计发电量", pic: cumulativeGeneration, key: "", data: "", unit: "度" },
        { name: "当前功率", pic: power, key: "", data: "", unit: "kW" },
        { name: "逆变器额定功率", pic: dayGeneration, key: "", data: "", unit: "kW" },
    ]);
