...
const schematicDiagramIconPrecent = 0.3;
const loadSystemAngle = 25; // 负载系统的角度

const energySystemLineWidthPercent = 0.55;
...
const citySystemLineWidthPercent = 0.8; // 线的百分比，自定义
...
const SchematicDiagram = ({ dataSource }) => {
    ...
    const initLineWidth = () => {
        const schematicDiagramRowHarfWidth = schematicDiagramRef?.current?.clientWidth / 2; // 盒子1/2宽
        const schematicDiagramColHardWidth = schematicDiagramRef?.current?.clientHeight / 2; // 盒子1/2高
