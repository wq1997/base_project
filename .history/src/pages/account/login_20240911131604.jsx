...
const Login = () => {
    ...
    const changeCodeImgUrl = () => {
        setCodeImgUrl("");
        setTimeout(_ => setCodeImgUrl(`${getBaseUrl()}/user/getKaptchaImage`), 0);
    };
    ...
    return (
        ...
        >
            ...
            >
                <Divider style={{ fontSize: "32px", marginBottom: 0, color: "#fff" }}>
                    欢迎登录
                </Divider>
                <p style={{ fontSize: "14px", textAlign: "center", marginTop: 0 }}>
                    WELCOME TO LOGIN
                </p>
                <Form
                    onFinish={onFinish}
                ...
                >
                                ...
                                <Input
                                    prefix={
                                        <ExclamationCircleOutlined
                                            style={{ fontSize: 15, color: "#73787F" }}
                                        />
                                    }
                    ...
                    <Form.Item name="remember" valuePropName="checked" style={{ marginBottom: 80 }}>
                        <Checkbox>
