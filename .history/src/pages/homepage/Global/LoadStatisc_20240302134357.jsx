    ...
    const getOptions = () => {
        setOptions({
            ...
            series: [{
                    name: '实时负载(KW)',
                    type: 'line',
                    data: [1200,2300,80,1360,3500,4500,5678,12999,23456,24567,33467,12789,42345,56721,72351,65432,37821,25121,50,10,40,50,110,80,50,10,40,50,100,80,90,90,80,110,80,50],
                    symbolSize: 1,
                    symbol: 'circle',
                    smooth: true,
                    yAxisIndex: 0,
