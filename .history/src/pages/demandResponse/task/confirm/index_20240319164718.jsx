...
const Confirm = () => {
    ...
    const getTaskDashboard = async () => {
        console.log(location?.search,getUrlParams(location?.search))
        const taskId = getUrlParams(location?.search)
        let res = await getWaitTaskDashboardServer();
        const list = res?.data?.data;
        if (res?.data?.status == "SUCCESS") {
            setTaskList(list);
            const index = taskId ? list?.findIndex(item => item.taskId == taskId) : 0;
            ...
            <div className={classNames("response-suggest", cardStyle)}>
                ...
                <div className="content">
                    ...
                    >
                        ...
                        >
                            {curTask?.projectedExecuteSuccessRate} %
                        </div>
            ...
            <div className={classNames("response-suggest", cardStyle)}>
                ...
                <div className="content">
                    ...
                    >
                        ...
                        >
                            {curTask?.executeResult?.success ? "成功" : "失败"}
                        </div>
                    </div>
                    <div
                        className="illustrate contentItem"
            ...
            <div className={classNames("wait-confirm", cardStyle)}>
                <div className="title">
                    ...
                    <div className="company" style={{ color: token.color11 }}>
                        {curTask?.companyName} {curTask?.taskId}
                    </div>
                </div>
                <div className="content">
                    <div className="desc">
