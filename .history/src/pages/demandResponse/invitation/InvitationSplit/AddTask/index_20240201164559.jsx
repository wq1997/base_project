...
const Company = ({ open, inviteId, editTask, remainCount, disabledCompanyCodes, onClose }) => {
    ...
    const [projectedMaxAdjustableLoad, setProjectedMaxAdjustableLoad] = useState();
    ...
    useEffect(() => {
        ...
        if (editTask) {
            ...
            setProjectedMaxAdjustableLoad(editTask?.projectedMaxAdjustableLoad);
        } else {
            form.resetFields();
            setProjectedMaxAdjustableLoad();
        }
    }, [open]);
                ...
                >
                    <Select
                        ...
                        onChange={value => {
                            ...
                            setProjectedMaxAdjustableLoad(projectedMaxAdjustableLoad);
                        }}
                    />
                </Form.Item>

                <Form.Item label="签约响应功率(kW)" name="projectedMaxAdjustableLoad">
                    <div
                        style={{
