...
const Company = ({ open, inviteId, onClose }) => {
    ...
    const [signResponsePower,setsignResponsePower]
    ...
    const onFinish = async values => {
        const { name, projectedMaxAdjustableLoad } = companies?.find(
            item => item.code == values?.companyCode
        );
        onClose({
            ...values,
            name,
            signResponsePower: projectedMaxAdjustableLoad,
        });
    };
