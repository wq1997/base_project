...
const Company = ({ open, inviteId, editTask, remainCount, disabledCompanyCodes, onClose }) => {
    ...
    const [responsePower, setSignResponsePower] = useState();
    ...
    const onFinish = async values => {
        ...
        onClose({
            ...
            companyName: name,
            projectedMaxAdjustableLoad: responsePower,
        });
    };
    ...
    useEffect(() => {
        ...
        if (editTask) {
            ...
            setSignResponsePower(editTask?.projectedMaxAdjustableLoad);
        } else {
            form.resetFields();
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Form.Item label="签约响应功率(kW)" name="responsePower">
                    <div
                        style={{
