...
const Account = () => {
    ...
    const getList = async invitationId => {
        const { current, pageSize } = paginationRef.current;
        const [releaseTimeFrom, releaseTimeStartTo] = releaseTimeRef.current || [];
        const invitationId = invitationId|| invitationIdRef.current || invitationId;
    ...
    useEffect(() => {
        const invitationId = getUrlParams(search)?.invitationId;
