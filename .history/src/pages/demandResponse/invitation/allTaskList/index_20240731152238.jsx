...
const Account = () => {
    ...
    const [ setCanRefuseOrConfirm, setCanRefuseOrConfirm] = useState()
    ...
    const onSelectChange = (newSelectedRowKeys, newSelectedRows) => {
        const hasNoRefuseOrConfirm = Boolean(newSelectedRows?.some(item => item.supportRefuseOrConfirm == false));
