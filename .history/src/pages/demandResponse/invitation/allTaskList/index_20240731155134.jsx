...
const Account = () => {
    ...
    const getSearchInitData = async () => {
        ...
        if (res?.data?.status == "SUCCESS") {
            const { exchangeTypes,szConfirmStatus, userConfirmStatus } = res?.data?.data;
            setUserConfirmStatusList(userConfirmStatus);
            setSzConfirmStatusList(szConfirmStatus);
            setResponseTypeList(exchangeTypes?.map(item=>({
               ...item,
                name:item?.showStr,
            })))
            setStationNameList(exchangeTypes?.map(item=>({
                ...item,
                 name:item?.showStr,
             })))
        }
