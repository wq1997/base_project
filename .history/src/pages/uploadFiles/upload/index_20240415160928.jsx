...
import { getUploadFilesInitData as getUploadFilesInitDataServer,saveUploadFiles as saveUploadFilesServer } from "@/services/api";
import "./index.less";
...
const Company = ({ uploadOpen, onClose }) => {
    ...
    const onFinish = async values => {
        ...
        values.testUnits?.forEach(unit => {
            formData.append("file", unit?.file[0]);
        });
