...
import { PlusCircleOutlined, PlusOutlined, MinusCircleOutlined, DeleteOutlined } from "@ant-design/icons";
                            ...
                            <>
                                {fields.map(({ key, name, ...restField }, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            {testFiles[index] ? (
                                                <Tooltip title={testFiles[index]?.name}>
                                                    <div
                                                        style={{
                                                            width: "144px",
                                                            whiteSpace: "nowrap",
                                                    ...
                                                    >
                                                        ...
                                                        <DeleteOutlined onClick={index => minustestFiles(index)} />
                                                    </div>
                                                </Tooltip>
                                            ) : (
                                                <Upload
