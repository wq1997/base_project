...
const Company = ({ uploadOpen, onClose }) => {
    ...
    const [testFiles, setTestFiles] = useState([{ value: undefined }]);
    const [editData, setEditData] = useState();

    const addFiles = () => {
        setTestFiles([...testFiles, { value: undefined }]);
    };

    const minusFiles = index => {
        const _files = [...testFiles];
                        ...
                        return (
                            <div style={{ marginBottom: "10px" }} key={index}>
                                <Input
                                    ...
                                    style={{ width: "70%", marginRight: "20px" }}
                                    value={item.value}
                                    onChange={e => (files[index].value = e.target?.value)}
                                />
                                {index == 0 ? (
                                    <PlusCircleOutlined
                                        onClick={addFiles}
