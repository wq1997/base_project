...
import { getUploadFilesInitData as getUploadFilesInitDataServer } from "@/services/api";
import "./index.less";
...
const Company = ({ uploadOpen, onClose }) => {
    ...
    const getInitData = async () => {
        const res = await import { getUploadFilesInitData as getUploadFilesInitDataServer } from "@/services/api";
        ();
        if (res?.data?.code == 0) {
