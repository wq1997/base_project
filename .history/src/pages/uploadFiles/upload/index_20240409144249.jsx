...
const Company = ({ uploadOpen, onClose }) => {
    ...
    const addtestUnit = () => {
        settestUnit([...testUnit, { name: undefined, file: undefined }]);
    };

    const minustestUnit = index => {
        const _testUnit = [...testUnit];
        _testUnit.splice(index, 1);
        settestUnit(_testUnit);
    };
                            ...
                            <>
                                {fields.map(({ key, name, ...restField }, index) => (
                                    ...
                                    >
                                        ...
                                        <Form.Item
                                            ...
                                            style={{ marginBottom: 0 }}
                                        >
                                            {testUnit[index]?.value ? (
                                                <Tooltip title={testUnit[index]?.value?.name}>
                                                    <div
                                                        style={{
                                                            width: "144px",
                                                            whiteSpace: "nowrap",
                                                ...
                                                <Upload
                                                    ...
                                                    onChange={({ file }) => {
                                                        const _testUnit = [...testUnit];
                                                        _testUnit[index].file = file;
                                                        console.log('_testUnit',_testUnit)
                                                        settestUnit(_testUnit);
                                                    }}
                                                >
                                ...
                                <Form.Item>
                                    <Button
                                        type="dashed"
                                        onClick={() => {
                                            const _testUnit = [...testUnit, { value: undefined }];
                                            settestUnit(_testUnit);
                                            add();
                                        }}
                                        block
