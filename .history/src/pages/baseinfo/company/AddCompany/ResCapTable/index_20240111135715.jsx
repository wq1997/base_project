...
const ResCapTable = ({ data, onChange }) => {
    ...
    return (
        <div className="resCapTable">
            {JSON.stringify(responsivenessDetail)}
            <div className="item">
                <div></div>
                <div>日前响应（KW）</div>
                <div>日中配置（KW）</div>
            ...
            <div className="item">
                ...
                <div>
                    <Input
                        value={responsivenessDetail?.lowPeakCut?.heightPeakCut}
                        onChange={e => change(e.target.value, "lowPeakCut", "dayBefore")}
                    />
                </div>
                <div>
                    <Input
                        value={responsivenessDetail?.dayIn}
                        onChange={e => change(e.target.value, "lowPeakCut", "dayIn")}
                    />
                </div>
                <div>
                    <Input
                        value={responsivenessDetail?.realTime}
