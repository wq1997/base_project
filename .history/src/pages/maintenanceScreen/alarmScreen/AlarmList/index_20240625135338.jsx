...
const Index = () => {
    ...
    return (
        <Card
          title="告警列表"
          content={ <Space className={styles.searchBar}>
          <SearchInput
              label="设备类型"
              value={deviceType}
              placeholder="请选择设备类型"
      ...
      <div className={styles.table}>
          ...
          <div className={styles.valueWrapper}>
              {[...values,...values,...values,...values,...values,...values,...values]?.map(value => (
                  <div className={styles.row}>
                      {columns?.map(column => (
                          <div className={styles.value}>{value[column.dataIndex]}</div>
                      ))}
                  </div>
              ))}
          </div>
