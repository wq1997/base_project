...
const ExceptionData = ({ infoId, onClose }) => {
    ...
    useEffect(() => {
        ...
        setTimeout(function () {
            ...
            document.getElementById('echartRef').offsetWidth + 'px' = document.getElementById('drawer').offsetWidth + 'px'
    ...
    return (
        ...
        >
            ...
            ></Table>
            <ReactECharts id='echartRef' option={options} style={{ width: "100%!important", height: "500px" }} />
        </Drawer>
    );
};
