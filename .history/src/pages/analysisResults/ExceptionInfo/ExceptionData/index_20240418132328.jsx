...
const ExceptionData = ({ infoId, onClose }) => {
    ...
    return (
        ...
        >
            <Descriptions title="">
                <Descriptions.Item label="簇号">{exceptionScene}</Descriptions.Item>
                <Descriptions.Item label="场景名称">1810000000</Descriptions.Item>
                <Descriptions.Item label="异常原因（仅供参考）">Hangzhou, Zhejiang</Descriptions.Item>
