...
const ExceptionData = ({ infoId, onClose }) => {
    ...
    const getInitData = async () => {
        ...
        if (res?.data?.code == 0) {
            ...
            if( sceneName=='CHARGE_HIGH_DISCHARGE_LOW'    ||sceneName=='CHARGE_LOW_DISCHARGE_LOW'       ||sceneName=='SINGLE_CELL_VOLTAGE_OUTLIER'    ){
    ...
    return (
        ...
        >
            <Descriptions title="">
                ...
                <Descriptions.Item label="场景名称">{exceptionScene?.sceneNameZh}</Descriptions.Item>
