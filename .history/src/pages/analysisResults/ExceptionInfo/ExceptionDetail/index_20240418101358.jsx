...
const ExceptionDetail = ({ dataDetailId, onClose }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, { id }) => {
                return (
                    <Button type="link" onClick={() => setdataDetailId(id)}>
                        查看详情
                    </Button>
                );
            },
    ...
    const getInitData = async () => {
        const res = await getAnalysisResultsDetailServer(dataDetailId);
        if (res?.data?.code == 0) {
