...
import { getExceptionDetail as getAnalysisResultsDetailServer } from "@/services/api";

const ExceptionDetail = ({ infoId, onClose }) => {
    ...
    const getInitData = async () => {
        const res = await getAnalysisResultsDetailServer(infoId);
        if (res?.data?.code == 0) {
