...
const Log = () => {
    const [dataSource, setDataSource] = useState([
        { level: "PROMPT", levelText: "提示", disposeType: "", limit: "", status: false },
        { level: "MINOR", levelText: "次要", disposeType: 1, limit: 1, status: false },
        { level: "IMPORTANT", levelText: "重要", disposeType: 2, limit: 2, status: true },
        { level: "URGENT", levelText: "紧急", disposeType: "", limit: "", status: false },
    ]);
