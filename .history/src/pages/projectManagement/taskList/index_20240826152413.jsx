...
const Account = () => {
    ...
    const getList = async () => {
        ...
        const [planDateFrom, planDateTo] = planDate.current || [];
        ...
        const res = await workOrderListServer({
            ...
            pageSize,
            queryCmd: {
                publishedTimeFrom, publishedTimeTo,
                statusIn,title,type,planDateFrom, planDateTo,
                projectId,ownerAccount,initiatorAccount,currentProcessorAccount
            },
        });
        if (res?.data?.status == "SUCCESS") {
