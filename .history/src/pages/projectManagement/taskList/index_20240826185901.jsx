...
const Account = () => {
    ...
    const [detailId, setDetailId] = useState('1814170422053261313');
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, { statusZh }) => {
                return (
                    <span style={{ color: statusZh == "COMPLETED" ? "#1BE72B" : "" }}>{statusZh}</span>
                );
            },
        },
        {
        ...
        },
        {
            ...
            render: (_, { statusZh, currentProcessorName }) => {
                return statusZh == "已完成" ? "" : currentProcessorName;
            },
        },
        {
            title: "实际处理人",
        ...
        },
        {
            ...
            render: (_, { id, supportProcessing }) => {
                return (
                    <Space>
                        <Button type="link" disabled={Boolean(!supportProcessing)}>
                            去处理
                        </Button>
                        <Button
                            type="link"
