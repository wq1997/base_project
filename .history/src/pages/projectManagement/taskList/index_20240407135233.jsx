    ...
    const [userList, setUserList] = useState([
        {
            ...
            launch: "李**",
            handle: "王**",
            groupName: "浙江源网侧集装箱项目巡检",
            checkInfo: [
                { item: "源网侧集装箱项目检查BMS运行数据", img: img8 },
                { item: "源网侧集装箱项目检查消防气体罐管道", img: img9 },
                { item: "源网侧集装箱项目检查消防主机模块", img: img10 },
                { item: "源网侧集装箱项目检查液冷机", img: img11 },
                { item: "源网侧集装箱项目检查液冷机", img: img12 },
                { item: "源网侧集装箱项目检查液冷机", img: img13 },
            ],
        },
        {
            id: 2,
