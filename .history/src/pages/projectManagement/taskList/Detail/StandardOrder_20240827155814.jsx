...
const Index = ({ info }) => {
    const getResult = (groupName, itemId) => {
        ...
        console.log(groupName, itemId,result,result?.find(group => group.groupName == groupName))
        if (result) {
            const findItemResult = result?.find(group => group.groupName == groupName)?.find(item=>item.id==itemId);
