...
const Index = ({ info, onClose }) => {
    ...
    const [deliveryStageUsers, setDeliveryStageUsers] = useState([]);
    const [debuggingStageUsers, setDebuggingStageUsers] = useState([]);
    const [runningStageUsers, setDebuggingStageUsers] = useState([]);
