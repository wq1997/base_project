    ...
    const Result = () => {
        return (
            <Descriptions title="" column={2}>
                <Descriptions.Item label="异常部件">{info?.exceptionInspectionItemName}</Descriptions.Item>
                ...
                <Descriptions.Item label="计划处理时间(天)">{info?.exceptionProcessingDaysForPlan}</Descriptions.Item>
                <Descriptions.Item label="实际处理时间(天)">{info?.exceptionProcessingDaysForActual}</Descriptions.Item>
                <span style={{ color: "rgba(255, 255, 255, 0.45)" }}>消缺成本</span>
                <Descriptions.Item label="差旅成本">{info?.exceptionProcessingCost?.travelCost}</Descriptions.Item>
                <Descriptions.Item label="耗材成本">{info?.exceptionProcessingCost?.consumablesCost}</Descriptions.Item>
                <Descriptions.Item label="备件成本">{info?.exceptionProcessingCost?.sparePartCost}</Descriptions.Item>
                <Descriptions.Item label="业主罚款">{info?.exceptionProcessingCost?.ownerFineCost}</Descriptions.Item>
                <Descriptions.Item label="人员成本">{info?.exceptionProcessingCost?.laborCost}</Descriptions.Item>
                <span style={{ color: "rgba(255, 255, 255, 0.45)" }}>消缺收益</span>
                <Descriptions.Item label="供应商罚款">{info?.exceptionProcessingCost?.supplierFineBenefit}</Descriptions.Item>
                <Descriptions.Item label="质保外维修收益(业务付款)">
                    {info?.exceptionProcessingCost?.warrantyExpiredPayBenefit}
                </Descriptions.Item>
                <Descriptions.Item label="消缺总结">{info?.exceptionProcessingResult}</Descriptions.Item>
                <Descriptions.Item label="附件">{info?.exceptionProcessingAttachments}</Descriptions.Item>
            </Descriptions>
        );
    };
