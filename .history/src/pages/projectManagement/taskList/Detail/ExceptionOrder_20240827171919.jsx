        ...
        return (
            <>
                ...
                >
                    ...
                    <Row span={24}>
                        <Col span={12}> <Form.Item label="业主罚款" name="description">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item></Col>
                        <Col span={12}> <Form.Item label="人员成本" name="description">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item></Col>
                    </Row>

                    <Row span={24}>
                        <Col span={12}> <Form.Item label="消缺收益" name="description">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item></Col>
                        <Col span={12}> <Form.Item label="供应商罚款" name="description">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item></Col>
                    </Row>

                    <Row span={24}>
                        <Col span={12}> <Form.Item label="质保外维修收益(业务fu款)" name="description">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item></Col>
