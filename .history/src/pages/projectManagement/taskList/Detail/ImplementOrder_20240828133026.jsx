...
const Index = ({ info, onClose }) => {
    ...
    const deliveryStageUploadUrl = baseUrl + "/work-order/upload-shipping-material";
    const debuggingStageUploadUrl = baseUrl + "/work-order/upload-testing-material";
    const runningStageuploadUrl = baseUrl + "/web-api/work-order/upload-trial-run-material";
        ...
        return (
            <>
                ...
                >
                    ...
                    >
                        <MyUpload url={deliveryStageUploadUrl} />
                    </Form.Item>
                    ...
                    >
                        <MyUpload url={debuggingStageUploadUrl} />
                    </Form.Item>
                    ...
                    >
                        <MyUpload url={runningStageuploadUrl} />
                    </Form.Item>
