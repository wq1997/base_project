        ...
        return (
            <>
                ...
                >
                    ...
                    <Row span={24}>
                        <Col span={12}>
                            <Form.Item label="计划处理时间(天)" name="exceptionProcessingDaysForPlan">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="实际处理时间(天)" name="exceptionProcessingDaysForActual">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row span={24}>
                        <Col span={12}>
                            <Form.Item label="质保外维修收益(业务付款)" name="warrantyExpiredPayBenefit">
                                <Input style={{ width: "100%" }} disabled={true} />
                            </Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row span={24}>
                        <Col span={12}>
                            <Form.Item label="exceptionProcessingAttachmentIds" name="files">
