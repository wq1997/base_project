        ...
        return (
            <>
                ...
                >
                    ...
                    <Row span={24}>
                        <Col span={12}>    <Form.Item label="计划处理时间(天)" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item></Col>
                        <Col span={12}>    <Form.Item label="消缺成本" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item>
</Col>
                    </Row>
                    ...
                    <Row span={24}>
                        <Col span={12}>   <Form.Item label="耗材成本" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item></Col>
