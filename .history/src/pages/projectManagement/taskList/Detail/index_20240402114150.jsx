    ...
    return (
        ...
        >
            <Descriptions title="基础信息">
                ...
                <Descriptions.Item label="计划结束时间">{detailRow?.projectName}</Descriptions.Item>a
                <Descriptions.Item label="关联项目名称">{detailRow?.projectName}</Descriptions.Item>
                <Descriptions.Item label="工单场景">
                {detailRow?.projectName}
                </Descriptions.Item>
                <Descriptions.Item label="发起人">{detailRow?.projectName}</Descriptions.Item>
                <Descriptions.Item label="处理人">{detailRow?.projectName}</Descriptions.Item>
                <Descriptions.Item label="计划开始时间">{detailRow?.projectName}</Descriptions.Item>
            </Descriptions>
