            ...
            <>
                ...
                >
                    <Row span={24}>
                        ...
                        <Col span={12}>  <Form.Item label="异常描述" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item></Col>
                    </Row>
                    
                    <Row span={24}>
                        <Col span={12}>           <Form.Item label="处理方案" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item></Col>
                        <Col span={12}> <Form.Item label="是否领用/采购备件或耗材" name="description">
                        <Input style={{ width: "100%" }} disabled={true} />
                    </Form.Item></Col>
                    </Row>
