...
const Index = ({ info, onClose }) => {
    ...
    const onFinish = async values => {
        const { consumablesCost, sparePartCost, ownerFineCost, laborCost,supplierFineBenefit,warrantyExpiredPayBenefit } = values;
        const res = await processExceptionWorkOrderServer({
            id: info?.id,
            ...values,
            exceptionProcessingCost: 1,
            exceptionProcessingBenefit: 1,
