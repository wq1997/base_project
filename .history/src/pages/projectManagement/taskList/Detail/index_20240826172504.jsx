    ...
    return (
        ...
        >
            <Descriptions title="基础信息">
                <Descriptions.Item label="工单名称">{info?.name}</Descriptions.Item>
                <Descriptions.Item label="关联项目名称">{detainfoilRow?.projectName}</Descriptions.Item>
                <Descriptions.Item label="处理人">{info?.end}</Descriptions.Item>
                <Descriptions.Item label="工单类型">{info?.type}</Descriptions.Item>
                <Descriptions.Item label="计划开始时间">{info?.start}</Descriptions.Item>
                <Descriptions.Item label="计划结束时间">{info?.end}</Descriptions.Item>
                <Descriptions.Item label="发起人">{info?.end}</Descriptions.Item>
            </Descriptions>
