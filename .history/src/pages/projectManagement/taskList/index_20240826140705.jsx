...
const Account = () => {
    ...
    const [workOrderType, setWorkOrderTypes] = useState();
    const [workOrderTypeOptions, setWorkOrderType] = useState();
    ...
    const getInitData = async () => {
        ...
        if (res?.data?.status == "SUCCESS") {
            const { statuses ,types} = res?.data?.data;
