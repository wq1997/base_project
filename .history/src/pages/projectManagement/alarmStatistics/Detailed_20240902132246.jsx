            ...
            >
                <div className={styles.images}>
                    <Descriptions column={1}>
                        ...
                        <Descriptions.Item label="所在地址">{currentRow?.name}</Descriptions.Item>
                        <Descriptions.Item label="产品类型">{currentRow?.name}</Descriptions.Item>
                        <Descriptions.Item label="项目阶段">{currentRow?.name}</Descriptions.Item>
