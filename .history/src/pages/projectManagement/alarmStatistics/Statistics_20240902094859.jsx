...
const Statistics = () => {
    ...
    const getOptions = async () => {
        ...
        if (type === "YEAR") {
            params = {
                productType: productType || initOption?.projects?.[0]?.id,
        ...
        if (type === "MONTH") {
            params = {
                productType: productType || initOption?.projects?.[0]?.code,
                groupType: groupType || initOption?.groupTypes?.[0]?.code,
    ...
    return (
        ...
        >
            <Space>
                <SearchInput
                    label="项目"
                    value={groupType || initOption?.projects?.[0]?.id}
                    type="select"
                    onChange={value => {
                        setGroupType(value);
                    }}
                    options={initOption?.projects}
                />
