            ...
            >
                <div className={styles.images}>
                    <Descriptions column={1}>
                        <Descriptions.Item label="项目名称">{currentRow?.project?.name}</Descriptions.Item>
                        <Descriptions.Item label="所在地址">{currentRow?.project?.address}</Descriptions.Item>
                        <Descriptions.Item label="产品类型">{currentRow?.project?.productTypeZh}</Descriptions.Item>
                        <Descriptions.Item label="项目阶段">{currentRow?.project?.phaseZh}</Descriptions.Item>
                        <Descriptions.Item label="项目进度">{currentRow?.project?.subPhaseZh}</Descriptions.Item>
                        <Descriptions.Item label="当前阶段负责人">
                            {currentRow?.project?.currentStepOwner}
                        </Descriptions.Item>
                        <Descriptions.Item label="负责人电话">{currentRow?.project?.name}</Descriptions.Item>
                    </Descriptions>
                </div>
            </Modal>
        </div>
