...
import AllAutoMode from './component/AllAutoMode'
                ...
                <div className={styles.mode}>
                    <Flex gap={18}>
                        ...
                        <Flex gap={30}>
                            ...
                            <div className={styles.selectionBox} style={{ backgroundColor: mode == 2 ? token.colorPrimary : token.buttonBgc }} onClick={() => changeType(2)} >{t('全自动')}</div>
                            <div className={styles.selectionBox} style={{ backgroundColor: mode == 1 ? token.colorPrimary : token.buttonBgc }} onClick={() => changeType(1)} >{t('半自动')}</div>
                        </Flex>
                    </Flex>
                </div>
                {mode == 1 ? 
                <AutoMode devId={devId} dtuId={id} historyAllData={historyAllData} /> :(mode==2?<AllAutoMode devId={devId} dtuId={id} historyAllData={historyAllData}/>: <ManualMode devId={devId} dtuId={id} historyAllData={historyAllData} />)}
            </Space>
            <Modal
                open={isModalOpen}
