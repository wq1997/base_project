...
export const getUserInfo = () => {
  return axiosInstance.post(`/user/standardUser/getCurrentUserInfo`);
}

export const saveSystemInfo = (payload) => {
  return axiosInstance.post(`/user/standardUser/saveCurrentUserInfo`, payload);
}